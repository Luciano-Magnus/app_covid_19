...
class AdapterBrasil(private val dados: MutableList<BoletimBrasil>) :
    RecyclerView.Adapter<AdapterBrasil.VH>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterBrasil.VH {
...
//            v.context.startActivity(enviarDados)
    ...
    override fun onBindViewHolder(holder: AdapterBrasil.VH, position: Int) {
